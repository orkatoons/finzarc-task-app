...
function Dashboard() {
    ...
    const fetchTasks = async () => {
        try {
            const res = await fetch(`https://finzarc-task-app.onrender.com/api/tasks?userId=${user.id}`);
    ...
    useEffect(() => {
        ...
        const editTasks = async (taskToEditId) => {
            try{
                ...
                const res = await fetch(`https://finzarc-task-app.onrender.com/api/tasks/edit?userId=${userId}&taskId=${taskToEditId}`);
                const data = await res.json();
        ...
        const createNewTask = async (e) => {
            try{
                ...
                const res = await fetch(`https://finzarc-task-app.onrender.com/api/tasks/create`, {
                    method:'POST',
                    headers: {
